...
-- Tiempo de generación: 19-06-2019 a las 15:54:11
...
(110, 'La materia orgánica que se encuentra en las rocas sedimentarias, puede ser de origen:', 2, 2),
...
(1104, 232, 'C', 'Contenido mineralógico', 0, 0),
...
(1186, 112, 'C', 'Saturación de agua', 0, 0),
...
(1, 'Individual 1', 1, 'ind_primer_ronda', 0, 12, 4, 12, 16, 0),
(2, 'Individual 2', 1, 'ind_segunda_ronda', 0, 12, 4, 12, 16, 0),
(3, 'Desempate Individual', 1, 'ind_desempate', 1, 4, 4, 4, 16, 0),
(4, 'Grupal 1', 2, 'grp_primer_ronda', 0, 4, 4, 4, 16, 0),
(5, 'Grupal 2', 2, 'grp_segunda_ronda', 0, 4, 4, 4, 16, 6),
...
CREATE TABLE `tablero_posiciones` (
  ...
  `TENGO_AJUSTE` smallint(2) DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `tablero_puntajes` (
  ...
  `TIEMPO` double DEFAULT '0',
  `PRE_RESPUESTA` int(6) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
ALTER TABLE `concursantes`
  MODIFY `ID_CONCURSANTE` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=89;

--
-- AUTO_INCREMENT de la tabla `concursos`
--
ALTER TABLE `concursos`
  MODIFY `ID_CONCURSO` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
...
--
ALTER TABLE `preguntas_generadas`
  MODIFY `ID_GENERADA` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `tablero_master`
  MODIFY `ID_TABLERO_MASTER` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=439;

--
-- AUTO_INCREMENT de la tabla `tablero_pasos`
--
ALTER TABLE `tablero_pasos`
  MODIFY `ID_TABLERO_PASO` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `tablero_posiciones`
--
ALTER TABLE `tablero_posiciones`
  MODIFY `ID_TABLERO_POSICION` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `tablero_puntajes`
--
ALTER TABLE `tablero_puntajes`
  MODIFY `ID_TABLERO_PUNTAJE` int(11) NOT NULL AUTO_INCREMENT;
