	...
	class TableroPuntaje extends BaseTable{
		...
		public function getResultados($concurso,$es_empate = false,$preliminar = false){
			...
			try{
				...
				tp.PUNTAJE,tp.NIVEL_EMPATE,tp.PREGUNTA_POSICION,tp.PASO_PREGUNTA as PASO, if(tp.CONCURSANTE_TOMO = 1,' y SI tomo la preguna','y NO tomo la pregunta') CONCURSANTE_TOMO,TIEMPO
				...
				$query.= " SELECT r.ID_RONDA,r.RONDA,c.CONCURSANTE,p.ID_PREGUNTA,p.PREGUNTA,w.INCISO,w.RESPUESTA,w.ES_IMAGEN,ca.CATEGORIA
								,'ROBA PUNTOS' AS PASO_PREGUNTAS,tps.PUNTAJE,'0' as NIVEL_EMPATE,tps.PREGUNTA_POSICION,'0' PASO,'' CONCURSANTE_TOMO, TIEMPO
