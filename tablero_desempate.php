...
<?php 
	...
	$empate = $tablero->esEmpate($sesion->getOne(SessionKey::ID_CONCURSO),true);
 ?>
<head>
	<meta charset="utf-8">
			...
			<div class="col-md-12">
				...
				<div id="divmejores">
					<table class="table table-bordered table-geo" id="tbl-mejores" style="width: 100%;">
						...
						<tbody>
							<?php 
								$response = $tablero->getMejoresPuntajes($sesion->getOne(SessionKey::ID_CONCURSO),true);
				...
				<div id="divtablero" style="display: none;">
					<table class="table table-bordered table-geo" id="tbl-puntaje" style="width: 100%;">
						...
						<tbody>
							<?php 
								$response = $tablero->getResultados($sesion->getOne(SessionKey::ID_CONCURSO),true);
